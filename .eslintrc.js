  ...
  overrides: [
    {
      ...
      rules: {
        ...
        // *hb* an Projekt anpassen
        "@angular-eslint/directive-selector": [
          "error",
          { type: "attribute", prefix: "lib-client", style: "camelCase" },
        ],
        ...
        "@angular-eslint/component-selector": [
          "error",
          { type: "element", prefix: "lib-client", style: "kebab-case" },
        ],
        ...
        "no-restricted-syntax": [
          ...
          {
            selector:
              // *hb* console.debug, .info erlauben
              'CallExpression[callee.object.name="console"][callee.property.name=/^(time|timeEnd|trace)$/]',
        ...
        // *hb* um Quotes kuemmert sich prettier
        // quotes: ["error", "single"],
