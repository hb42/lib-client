(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/router'), require('@angular/common'), require('semver'), require('@angular/common/http'), require('@hb42/lib-common'), require('rxjs'), require('rxjs/operators'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@hb42/lib-client', ['exports', '@angular/router', '@angular/common', 'semver', '@angular/common/http', '@hb42/lib-common', 'rxjs', 'rxjs/operators', '@angular/core'], factory) :
    (factory((global.hb42 = global.hb42 || {}, global.hb42['lib-client'] = {}),global.ng.router,global.ng.common,global.semver,global.ng.common.http,global['@hb42/lib-common'],global.rxjs,global.rxjs.operators,global.ng.core));
}(this, (function (exports,router,common,semver,http,libCommon,rxjs,operators,core) { 'use strict';
    ...
    var FlexboxSplitter = /** @class */ (function () {
        ...
        /** @nocollapse */
        FlexboxSplitter.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
        FlexboxSplitter.propDecorators = {
            storageId: [{ type: core.Input }]
        };
    ...
    var VersionService = /** @class */ (function () {
        function VersionService(http$$1, electronService, location) {
            this.http = http$$1;
            this.electronService = electronService;
    ...
    var LogonInterceptor = /** @class */ (function () {
         ...
         */
            function (request, next) {
                ...
                if (!this.logonService.active || this.isWhitelisted(request)) {
                    ...
                    return rxjs.from(token).pipe(operators.mergeMap(( /**
                     * @param {?} asyncToken
                     * @return {?}
                     */function (asyncToken) {
                        var _a;
        ...
        /** @nocollapse */
        LogonInterceptor.ctorParameters = function () {
            return [
                { type: LogonService },
                { type: ErrorService }
            ];
