(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/common/http'), require('@angular/core'), require('@angular/router'), require('@hb42/lib-common'), require('rxjs'), require('rxjs/operators'), require('semver')) :
    typeof define === 'function' && define.amd ? define('@hb42/lib-client', ['exports', '@angular/common', '@angular/common/http', '@angular/core', '@angular/router', '@hb42/lib-common', 'rxjs', 'rxjs/operators', 'semver'], factory) :
    (global = global || self, factory((global.hb42 = global.hb42 || {}, global.hb42['lib-client'] = {}), global.ng.common, global.ng.common.http, global.ng.core, global.ng.router, global.libCommon, global.rxjs, global.rxjs.operators, global.semver));
}(this, (function (exports, common, http, core, router, libCommon, rxjs, operators, semver) { 'use strict';
