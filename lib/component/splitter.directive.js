...
/** @nocollapse */ FlexboxSplitter.ɵfac = function FlexboxSplitter_Factory(t) { return new (t || FlexboxSplitter)(i0.ɵɵdirectiveInject(i0.ElementRef)); };
/** @nocollapse */ FlexboxSplitter.ɵdir = i0.ɵɵdefineDirective({ type: FlexboxSplitter, selectors: [["", "fb-splitter", ""]], inputs: { storageId: "storageId" } });
/*@__PURE__*/ (function () { i0.ɵsetClassMetadata(FlexboxSplitter, [{
        type: Directive,
        args: [{
                selector: "[fb-splitter]",
            }]
    }], function () { return [{ type: i0.ElementRef }]; }, { storageId: [{
            type: Input
        }] }); })();
if (false) {
    /** @type {?} */
