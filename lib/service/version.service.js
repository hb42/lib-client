...
/** @nocollapse */ VersionService.ɵfac = function VersionService_Factory(t) { return new (t || VersionService)(i0.ɵɵinject(i1.HttpClient), i0.ɵɵinject(i2.ElectronService), i0.ɵɵinject(i3.Location)); };
/** @nocollapse */ VersionService.ɵprov = i0.ɵɵdefineInjectable({ token: VersionService, factory: VersionService.ɵfac });
/*@__PURE__*/ (function () { i0.ɵsetClassMetadata(VersionService, [{
        type: Injectable
    }], function () { return [{ type: i1.HttpClient }, { type: i2.ElectronService }, { type: i3.Location }]; }, null); })();
if (false) {
    /**
     * @type {?}
     * @private
