...
/** @nocollapse */ ErrorService.ɵfac = function ErrorService_Factory(t) { return new (t || ErrorService)(i0.ɵɵinject(i0.Injector), i0.ɵɵinject(i1.ElectronService)); };
/** @nocollapse */ ErrorService.ɵprov = i0.ɵɵdefineInjectable({ token: ErrorService, factory: ErrorService.ɵfac });
/*@__PURE__*/ (function () { i0.ɵsetClassMetadata(ErrorService, [{
        type: Injectable
    }], function () { return [{ type: i0.Injector }, { type: i1.ElectronService }]; }, null); })();
if (false) {
    /** @type {?} */
